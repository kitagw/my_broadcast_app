...
# (str) Package name
package.name = my_broadcast_app

# (str) Package domain (needed for android/ios packaging)
package.domain = org.kitagw
...
#services = myservice:service/main.py:foreground:dataSync
services = myservice:service/main.py:foreground:foregroundServiceType=dataSync
...
android.permissions = INTERNET, WAKE_LOCK, FOREGROUND_SERVICE, FOREGROUND_SERVICE_DATA_SYNC, POST_NOTIFICATIONS, READ_APP_SPECIFIC_LOCALES
